...
const fastButtonToAct = document.querySelector('.overlap-16')
const fastButtonToBib = document.querySelector('.overlap-17')
...
const clear = () => {
    ...
    document.documentElement.style.setProperty("--arrow-visible", "hidden")
...
const toPoint = () => {
    ...
    if (point === "toilet") {
        ...
        document.documentElement.style.setProperty("--arrow-visible", "visible")
